...
public class CircleBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        Log.e("----","onDraw");
        canvas.drawArc(mColorWheelRectangle, 0, 90, false, mDefaultWheelPaint);//画外接的圆环
//        canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),R.mipmap.ic_launcher),mColorWheelRectangle.right,200,new Paint());
        canvas.drawArc(mColorWheelRectangle, 0, mSweepAnglePer, false, mColorWheelPaint);//画圆环
...
//        canvas.drawText(
//                textstr + "", (mColorWheelRectangle.centerX()) - (textPaint.measureText(textstr) / 2),
//                mColorWheelRectangle.centerY() + bounds.height() / 2 - 50, textPaint);
        canvas.drawText(
                textstr + "", (mColorWheelRectangle.left/2),
                mColorWheelRectangle.bottom, textPaint);
    }
